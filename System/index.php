...
<head>
	...
	<title>CAREER HUB - Job Portal</title>
    ...
    <meta property="og:image:alt" content="Career Hub" />
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/03.jpg');">
				<div class="container">
					...
					<h1>Leading The Change In The Corporate World</h1>
					<p>Fill The Spot, Get On The Spot</p>
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<br><h2><span style="text-transform:uppercase;">R</span>andom <span style="text-transform:uppercase;">C</span>ompanies</h2>
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<h2><span style="text-transform:uppercase;">L</span>atest <span style="text-transform:uppercase;">J</span>obs</h2>
				...
				<div class="container">
					...
					<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-4">
									...
									<div class="footer-about-us">
										<h5 class="footer-title">About CAREER HUB</h5>
										<p>Career Hub is a job portal, online job management system developed by Shreshthi,Priyanshu,Shubham,Yashika,Nimish for his project in August 2022.</p>
						...
						<div class="col-sm-12 col-md-3 mt-30-sm">
							...
							<h5 class="footer-title">CAREER HUB Contact</h5>
							
							<p>Address : DGM Homes,Kharar </p>
							<p>Email : <a href="mailto:shreshthijain07@gmail.com">shreshthijain07@gmail.com</a></p>
							<p>Phone : <a href="tel:+7021542226">+7021542226</a></p>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-4">
							...
							<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Career Hub Vision Software</p>
						...
						<div class="col-sm-4 col-md-4">
							...
							<ul class="bottom-footer-menu">
								<li><a >Developed by Shreshthi,Shubham,Yashika,Priyanshu,Nimish</a></li>
							</ul>
						...
						<div class="col-sm-4 col-md-4">
							<ul class="bottom-footer-menu for-social">
								<li><a href="<?php echo "https://twitter.com/i/flow/login"; ?>"><i class="ri ri-twitter" data-toggle="tooltip" data-placement="top" title="twitter"></i></a></li>
								<li><a href="<?php echo "https://www.facebook.com/yashika.tomar.338"; ?>"><i class="ri ri-facebook" data-toggle="tooltip" data-placement="top" title="facebook"></i></a></li>
								<li><a href="<?php echo "https://www.instagram.com/shreshthii/"; ?>"><i class="ri ri-instagram" data-toggle="tooltip" data-placement="top" title="instagram"></i></a></li>
							</ul>
						</div>
